...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_know_button}", "click", function(sym, e) {
         var parent = sym.getParentSymbol();
         parent.play();
         updateNotifications();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 528, function(sym, e) {
         checkNotifications(sym);
         stop();
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_Rectangle3}", "click", function(sym, e) {
         var popup = sym.getSymbol('mission_popup');
         popup.stop('text1');
         popup.getSymbolElement().css('display', 'block');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_Rectangle3Copy}", "click", function(sym, e) {
         var popup = sym.getSymbol('mission_popup');
         popup.stop('text2');
         popup.getSymbolElement().css('display', 'block');
      ...
      Symbol.bindElementAction(compId, symbolName, "${_more_button}", "click", function(sym, e) {
         nextBlink();
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_video}", "click", function(sym, e) {
         showVideo(sym);
   ...
   //Edge symbol: 'mission_popup'
   (function(symbolName) {   
   
      Symbol.bindElementAction(compId, symbolName, "${_popup_close}", "click", function(sym, e) {
   ...
   //Edge symbol end:'mission_popup'

   //=========================================================
   
   //Edge symbol: 'popup_close'
   (function(symbolName) {   
   
   })("popup_close");
   //Edge symbol end:'popup_close'
